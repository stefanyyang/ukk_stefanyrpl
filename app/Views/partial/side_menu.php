    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="<?=base_url('assets/images/faces/face10.jpg')?>" alt="">
                  <span class="count bg-success"></span>
                </div>
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">Stefany Yang</h5>
        ...
        <!--     <a class="nav-link" href="index.html"> -->
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="<?=base_url('home/pelanggan')?>">
              <span class="menu-icon">
           ...
           <li class="nav-item menu-items">
            <a class="nav-link" href="<?=base_url('home/produk')?>">
              <span class="menu-icon">
                <i class="mdi mdi-playlist-play"></i>
              </span>
           ...
           <li class="nav-item menu-items">
            <a class="nav-link" href="<?=base_url('home/penjualan')?>">
              <span class="menu-icon">
                <i class="mdi mdi-playlist-play"></i>
              </span>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="<?=base_url('assets/images/faces/face10.jpg')?>" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">Stefany Yang</p>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="preview-list">
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="<?=base_url('assets/images/faces/face6.jpg" alt="image')?>" class="rounded-circle" />
                        </div>
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="<?=base_url('assets/images/faces/face8.jpg')?>" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="<?=base_url('assets/images/faces/face9.jpg')?>" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="<?=base_url('assets/images/faces/face11.jpg')?>" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel" id="owl-carousel-basic">
                      <div class="item">
                        <img src="<?=base_url('')?>/images/dashboard/Rectangle.jpg')?>" alt="">
                      </div>
                      <div class="item">
                        <img src="<?=base_url('assets/images/dashboard/Img_5.jpg')?>" alt="">
                      </div>
                      <div class="item">
                        <img src="<?=base_url('assets/images/dashboard/img_6.jpg')?>" alt="">
                      </div>
                    </div>
                    <div class="d-flex py-4">
                      <div class="preview-list w-100">
                        <div class="preview-item p-0">
                          <div class="preview-thumbnail">
                            <img src="<?=base_url('assets/images/faces/face12.jpg')?>" class="rounded-circle" alt="">
                          </div>
                          <div class="preview-item-content d-flex flex-grow">
                            <div class="flex-grow">
                              <div class="d-flex d-md-block d-xl-flex justify-content-between">
